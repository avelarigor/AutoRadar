...
OUT_PATH   = Path("logs/monitor_2h_report.log")
...
def run_monitor():
    log("=" * 60)
    log("MONITOR 2H — AutoRadar iniciado")
    ...
    # ── RESUMO FINAL ──────────────────────────────────────
    log("\n" + "=" * 60)
    log("RESUMO FINAL — 2 HORAS DE MONITORAMENTO")
    log("=" * 60)
